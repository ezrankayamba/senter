package tz.co.nezatech.senter.event.listener;
...
import tz.co.nezatech.senter.data.repository.VerificationTokenRepository;
import tz.co.nezatech.senter.event.OnRegistrationCompleteEvent;
import tz.co.nezatech.senter.service.EmailServiceImplSync;
